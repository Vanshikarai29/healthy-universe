<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Vendor-Login.aspx.cs" Inherits="Vendor_Login" %>
...
<title>Vendor Login Dashboard | Healthy Universe.</title>
...
<div id="main-wrapper"> 
  ...
  <div class="container-fluid px-0">
    <section class="hero-wrap">
      ...
      <div class="hero-bg" style="background-image:url(images/Vendor.png) !important;"></div>
        ...
        <div class="container py-5 px-4 px-lg-5 my-auto">
          <div class="row py-5 py-sm-4">
            <div class="col-12 text-center mx-auto">
              ...
              <h2 class="text-5 text-white fw-700 mb-2" style="font-weight:600 !important;text-transform:uppercase !important;">Vendor Member Dashboard</h2>
            </div>
            <div class="col-md-8 col-lg-6 col-xl-5 mx-auto text-center">
              <p class="text-2 text-light mb-3">Use the following form to continue to your dedicated Vendor dashboard.</p>
              <!-- Subscribe Form -->
			  <div class="subscribe-form">
                ...
                <div class="d-grid mt-2" style="margin-top:0.5em !important;">
                 ...
                 <a href="Registration.aspx" style="float: left;margin-top: 10px; color: #fff;padding: 5px;border: 1px saddlebrown;">Registration Now  ➡️ </a>        <asp:Button ID="Button2" OnClick="Button2_Click" runat="server" Text="Forget Password" style="float: right;margin-top: 10px; color: #fff;padding: 5px;text-decoration:underline !important;border: none;background: none;" />
              </div>
