<%@ Page Title="" Language="C#" MasterPageFile="~/System-Administrator/MasterPage.master" AutoEventWireup="true" CodeFile="Lab-Departments.aspx.cs" Inherits="System_Administrator_Lab_Departments" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <style type="text/css">
       ...
       <main style="margin-top: 85px !important;">
        <div class="container-fluid">
                <div class="row  ">
                <div class="col-12">
                    <h1 style="margin-bottom:0px !important;padding-bottom:0px !important;font-size:17px !important;"><b>Labs Department</b> Management</h1>
                    <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" style="float:right !important;margin-top:0px !important;" aria-label="breadcrumb">
                        <ol class="breadcrumb pt-0" style="margin-bottom:0rem !important;padding:0px !important;">
                            ...
                            <li class="breadcrumb-item">
                                <a href="#">Manage Labs Departments</a>
                            </li>
                        </ol>
                    </nav>
                ...
                <div class="col-md-12 col-lg-6 col-xl-4 mb-4">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <p style="margin-bottom:1.4rem !important;">Add a new labs department to the network.</p>
    ...
    Display="Dynamic" /></label>
                 ...
                 <div class="col-md-12 col-lg-6 col-xl-8 mb-4">
                    <div class="card mb-4">
                        <div class="card-body">
                            <h6 class="mb-3" style="font-weight:bold !important;text-transform:uppercase !important;font-size:15px !important;margin-bottom:6px !important;">B. Existing Labs Departments</h6>
                            <p style="margin-bottom:1.4rem !important;">Manage Labs Departments listed over the network.</p>
 ...
 <asp:Label ID="lb2" style="color:black !important" runat="server" Text='<%#Eval("Id") %>'/>
        ...
        <asp:TemplateField HeaderText="Labs Departments">
 <ItemTemplate>
...
<h2 style="padding-top:30px;font-size:19px !important;color:#00365a !important;font-weight:bold !important;">No Labs Departments were Found!</h2>
                          <p>No Labs Departments were found in the database. It is recommended to add few before proceeding to listing products / services.</p>
