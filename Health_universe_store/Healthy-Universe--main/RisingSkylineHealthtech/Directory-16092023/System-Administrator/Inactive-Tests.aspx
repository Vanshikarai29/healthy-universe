<%@ Page Title="" Language="C#" MasterPageFile="~/System-Administrator/MasterPage.master" AutoEventWireup="true" CodeFile="Inactive-Tests.aspx.cs" Inherits="System_Administrator_Inactive_Tests" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <script type="text/javascript">
       ...
       <main style="margin-top: 95px !important;">
        <div class="container-fluid">
                <div class="row  ">
                <div class="col-12">
                    <h1 style="margin-bottom:0px !important;padding-bottom:0px !important;font-size:17px !important;"><b>New Tests</b> Management</h1>
                 ...
                 <div class="col-md-12 col-lg-12 col-xl-12 mb-4">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <h6 class="mb-3" style="font-weight:bold !important;text-transform:uppercase !important;font-size:15px !important;margin-bottom:3px !important;">New Tests Requests</h6>
                            <p style="margin-bottom:1.4rem !important;">Following datalist allows you to accept / reject new tests over the network.</p>
 ...
 <ItemTemplate>
    ...
    <b>Test ID</b>: <asp:Label ID="lbldesc6jhgh" style="color:black !important"  runat="server" Text='<%#Eval("Id").ToString()%>'/><br/>
<b>Tests Name</b>: <asp:Label ID="lbldesc6" style="color:black !important"  runat="server" Text='<%#Eval("Title").ToString()%>'/><br/>
...
<br/><b>Preparations</b>: <asp:Label ID="Label7" style="color:black !important"  runat="server" Text='<%#Eval("Ktag").ToString()%>'/>
         ...
         <br/>
<asp:Button ID="Button2" runat="server" CommandName="Advanced" CommandArgument='<%#Eval("Id")%>'  Text="Accept Request"  style="background-color:green !important;color:white !important;border:none !important;padding:5px 10px !important;border-radius:3px !important;"></asp:Button>
 ...
 <ItemTemplate>
       <div style="background-color:#fafafa !important;">
     <div style="padding:10px !important;">
    <asp:Image ID="Image2" style="width: 100px !important;height: 100px !important; padding: 20px !important;" ImageUrl='<%#Eval("Path1") %>' runat="server" />      
   <asp:Image ID="Image1" style="width: 100px !important;height: 100px !important; padding: 20px !important;" ImageUrl='<%#Eval("Path3") %>' runat="server" />      
   </div>
      </div>
 </ItemTemplate>
