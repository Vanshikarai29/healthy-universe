...
public partial class System_Administrator_Banners : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if(count1 > 0)
        {
            videoavailable.Style.Add("display", "block");
            videounavailable.Style.Add("display", "none");
        }
        else
        {
            videoavailable.Style.Add("display", "none");
            videounavailable.Style.Add("display", "block");
        }
    ...
    protected void BindGrid()
    {
        ...
        try
        {
            SqlCommand cmd = new SqlCommand("select * from Banners", con);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string str = ConfigurationManager.ConnectionStrings["constr"].ConnectionString;
            SqlConnection con1 = new SqlConnection(ConfigurationManager.ConnectionStrings["constr"].ConnectionString);
            SqlCommand cmd1 = new SqlCommand("Insert into Banners (Title,Path1) values (@Title,@Path1)", con1);
    ...
    protected void grdImages_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("delete from Banners where Id=@Id", con);
    ...
    protected void grdImages_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        try
        {
            ...
            using (SqlConnection con1 = new SqlConnection(constr))
            {
                ...
                con1.Open();
                SqlCommand cmd1 = new SqlCommand("update Banners set Title=@Title, Path1=@Path1 where Id=" + id, con1);
    ...
    protected void Button5_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                fileName = Guid.NewGuid() + FileUpload2.FileName;
            ...
            string str = ConfigurationManager.ConnectionStrings["constr"].ConnectionString;
            SqlConnection con1 = new SqlConnection(ConfigurationManager.ConnectionStrings["constr"].ConnectionString);
            SqlCommand cmd1 = new SqlCommand("Insert into Bannervideo (Path1) values (@Path1)", con1);
            cmd1.Parameters.AddWithValue("@Path1", path1);
            if (con1.State == ConnectionState.Closed)
            {
                con1.Open();
    ...
    protected void Button6_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                fileName = Guid.NewGuid() + FileUpload3.FileName;
    ...
    protected void Button7_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("delete from Bannervideo", con);
            cmd.CommandType = CommandType.Text;
            con.Open();
            cmd.ExecuteNonQuery();
            cmd.Dispose();
