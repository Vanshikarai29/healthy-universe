<%@ Page Title="" Language="C#" MasterPageFile="~/System-Administrator/MasterPage.master" AutoEventWireup="true" CodeFile="Additional-Banners.aspx.cs" Inherits="System_Administrator_Discount_Banners" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <style type="text/css">
       ...
       <main style="margin-top: 85px !important;">
        <div class="container-fluid">
            <div class="row  ">
                <div class="col-12">
                    <h1 style="margin-bottom:0px !important;padding-bottom:0px !important;font-size:17px !important;"><b>Footer Banner</b> Management</h1>
                ...
                <div class="col-md-12 col-lg-6 col-xl-4 mb-4">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <h6 class="mb-3" style="font-weight:bold !important;text-transform:uppercase !important;font-size:15px !important;margin-bottom:6px !important;">A. Add Optional Banners</h6>
                            <p style="margin-bottom:1.4rem !important;">Add a new banner to the frontpage above footer section.</p>
    ...
    Display="Dynamic" /></label>
                              ...
                              <asp:Button ID="Button1" ValidationGroup="one" class="btn btn-secondary" runat="server" OnClick="Button1_Click" style="border-radius:3px !important;" Text="Add New Banner" />
                 ...
                 <div class="col-md-12 col-lg-6 col-xl-8 mb-4">
                    <div class="card mb-4">
                        <div class="card-body">
                            <h6 class="mb-3" style="font-weight:bold !important;text-transform:uppercase !important;font-size:15px !important;margin-bottom:6px !important;">B. Manage Existing Banners</h6>
                            <p style="margin-bottom:1.4rem !important;">Manage optional banners listed on the network.</p>
...
<h2 style="padding-top:30px;font-size:19px !important;color:#00365a !important;font-weight:bold !important;">No Banners were Found!</h2>
                          <p>No banners were found in the database. You can use the adjacent controls to add one.</p>
