...
public partial class System_Administrator_Services : System.Web.UI.Page
{
    ...
    protected void BindGrid()
    {
        ...
        try
        {
            SqlCommand cmd = new SqlCommand("select * from Servicecategory", con);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("Select Title from Servicecategory where Title=@Title", con);
            ...
            if (dr.Read())
            {
                if (dr.HasRows == true)
                {
                    Response.Write(@"<script language='javascript'>alert('Service already Exists.')</script>");
                    con.Close();
                }
            }
            else
            {
                ...
                SqlCommand cmd1 = new SqlCommand("Insert into Servicecategory (Title,Path1) values (@Title,@Path1)", con1);
    ...
    protected void grdImages_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            SqlConnection con1 = new SqlConnection(constring);
                ...
                SqlCommand cmd = new SqlCommand("delete from Servicecategory where Id=@Id", con);
    ...
    protected void grdImages_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        try
        {
            ...
            using (SqlConnection con1 = new SqlConnection(constr))
            {
                ...
                con1.Open();
                SqlCommand cmd1 = new SqlCommand("update Servicecategory set Title=@Title, Path1=@Path1 where Id=" + id, con1);
