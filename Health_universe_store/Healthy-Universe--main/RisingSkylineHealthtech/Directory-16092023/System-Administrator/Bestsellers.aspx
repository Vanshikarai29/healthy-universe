<%@ Page Title="" Language="C#" MasterPageFile="~/System-Administrator/MasterPage.master" AutoEventWireup="true" CodeFile="Bestsellers.aspx.cs" Inherits="System_Administrator_Bestsellers" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <style type="text/css">
      ...
      <main style="margin-top: 85px !important;">
        <div class="container-fluid">
            <div class="row  ">
                <div class="col-12">
                    <h1 style="margin-bottom:0px !important;padding-bottom:0px !important;font-size:17px !important;"><b>Bestsellers</b> Override Management</h1>
                 ...
                 <div class="col-md-12 col-lg-6 col-xl-12 mb-4">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <h6 class="mb-3" style="font-weight:bold !important;text-transform:uppercase !important;font-size:15px !important;margin-bottom:6px !important;">Override Bestseller Listing</h6>
                            <p style="margin-bottom:1.4rem !important;">Following data helps in assigning your products as Bestsellers.</p>
 ...
 <asp:DropDownList ID="DropDownList2" CssClass="form-control" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged"
    ...
    <Columns>
      ...
      <asp:Button ID="btnGetSelected" runat="server" Text="Update Bestseller List" class="btn btn-secondary" style="margin-top:15px !important;"  OnClick="GetSelectedRecords" />
