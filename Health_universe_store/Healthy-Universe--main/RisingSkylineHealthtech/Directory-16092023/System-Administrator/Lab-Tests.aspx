<%@ Page Title="" Language="C#" MasterPageFile="~/System-Administrator/MasterPage.master" AutoEventWireup="true" CodeFile="Lab-Tests.aspx.cs" Inherits="System_Administrator_Lab_Tests" %>
...
<main style="margin-top: 70px !important;">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-6 col-xl-8 mb-4">
                   ...
                   <div class="col-md-12 mb-3">
                                        <label for="validationTooltipUsername2" style="width:100% !important;">Test Title  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="one" 
     ...
     <div class="col-md-6 mb-3">
                    ...
                    <asp:TextBox ID="TextBox4" class="form-control" TextMode="MultiLine" style="color:darkslateblue !important;" placeholder="Type here..." runat="server"></asp:TextBox>
                           ...
                           <div class="col-md-6 mb-3">
                                        <label for="validationTooltipUsername2" style="width:100% !important;">No of Tests  <asp:RequiredFieldValidator ID="RequiredFieldValidator3sx" ValidationGroup="one" 
                        style="color:Red;font-weight:bold;font-size:12px;"  runat="server"
                         Text="*"
                     ...
                     <asp:TextBox ID="TextBox6" class="form-control" onchange="validateFloatKeyPress(this);" style="color:darkslateblue !important;" placeholder="Type here..." runat="server"></asp:TextBox>
                                 ...
                                 <label for="validationTooltipUsername2" style="width:100% !important;margin-top:10px !important;">Price <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ValidationGroup="one" 
                        style="color:Red;font-weight:bold;font-size:12px;"  runat="server"
                         Text="*"
...
<b>Test ID</b> <asp:Label ID="lb1" style="color:black !important" runat="server" Text='<%#Eval("Id") %>'/><br/>
                  ...
                  <asp:DropDownList  class="form-control" style="padding: 5px 18px !important;" ID="DropDownList2" runat="server">
                            <asp:ListItem Value="0">Out Of Stock</asp:ListItem>
                  ...
                  <br/><br/>
                  <asp:Button ID="Button2" ValidationGroup="three" CommandName="Update" runat="server" Text="Update"></asp:Button>&nbsp;<asp:Button ID="Button3" runat="server" CommandName="Cancel" Text="Cancel"></asp:Button>
