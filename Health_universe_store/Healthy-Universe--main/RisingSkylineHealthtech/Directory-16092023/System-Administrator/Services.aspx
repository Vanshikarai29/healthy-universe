<%@ Page Title="" Language="C#" MasterPageFile="~/System-Administrator/MasterPage.master" AutoEventWireup="true" CodeFile="Services.aspx.cs" Inherits="System_Administrator_Services" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      <style type="text/css">
       ...
       <main style="margin-top: 85px !important;">
        <div class="container-fluid">
                <div class="row  ">
                <div class="col-12">
                    <h1 style="margin-bottom:0px !important;padding-bottom:0px !important;font-size:17px !important;"><b>Services</b> Management</h1>
                ...
                <div class="col-md-12 col-lg-6 col-xl-4 mb-4">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <h6 class="mb-3" style="font-weight:bold !important;text-transform:uppercase !important;font-size:15px !important;margin-bottom:6px !important;">A. List a Service</h6>
                            <p style="margin-bottom:1.4rem !important;">Add a new service to the network.</p>

                            <div class="needs-validation mb-5">
                                
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        <label for="validationTooltipUsername2" style="width:100% !important;">Service Title <asp:RequiredFieldValidator ID="reg1" ValidationGroup="one" 
                        style="color:Red;font-size:12px;float:right !important;" runat="server"
                         ...
                         ForeColor="Red" ControlToValidate="TextBox1"></asp:RequiredFieldValidator></label>
                                   ...
                                   <div class="col-md-12 mb-3">
                                        <label for="validationTooltipUsername2" style="width:100% !important;">Service Banner <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="one" 
    ...
    Display="Dynamic" /></label>
                              ...
                              <asp:Button ID="Button1" ValidationGroup="one" class="btn btn-secondary" runat="server" OnClick="Button1_Click" style="border-radius:3px !important;" Text="Add New Service" />
                 ...
                 <div class="col-md-12 col-lg-6 col-xl-8 mb-4">
                    <div class="card mb-4">
                        <div class="card-body">
                            <h6 class="mb-3" style="font-weight:bold !important;text-transform:uppercase !important;font-size:15px !important;margin-bottom:6px !important;">B. Existing Services</h6>
                            <p style="margin-bottom:1.4rem !important;">Manage Services listed over the network.</p>
...
<h2 style="padding-top:30px;font-size:19px !important;color:#00365a !important;font-weight:bold !important;">No Services were Found!</h2>
                          <p>No services were found in the database. It is recommended to add few before proceeding to listing service providers.</p>
