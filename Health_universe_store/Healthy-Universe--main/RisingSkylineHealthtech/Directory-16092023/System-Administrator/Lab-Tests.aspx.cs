...
public partial class System_Administrator_Lab_Tests : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string str = ConfigurationManager.ConnectionStrings["constr"].ConnectionString;
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["constr"].ConnectionString);
            SqlCommand cmd = new SqlCommand("Insert into Tests (Title,Description,Quantity,categoryid,Categoryname,Price,Price1,Path1,IsSelected,Weight,Path3,Dtag,Ktag,Status) values (@Title,@Description,@Quantity,@categoryid,@Categoryname,@Price,@Price1,@Path1,@IsSelected,@Weight,@Path3,@Dtag,@Ktag,@Status)", con);
