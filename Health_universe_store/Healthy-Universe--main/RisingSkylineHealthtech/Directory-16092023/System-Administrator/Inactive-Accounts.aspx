<%@ Page Title="" Language="C#" MasterPageFile="~/System-Administrator/MasterPage.master" AutoEventWireup="true" CodeFile="Inactive-Accounts.aspx.cs" Inherits="System_Administrator_Inactive_Accounts" %>
     ...
     <script type="text/javascript">
       ...
       <main style="margin-top: 95px !important;">
        <div class="container-fluid">
                <div class="row  ">
                <div class="col-12">
                    <h1 style="margin-bottom:0px !important;padding-bottom:0px !important;font-size:17px !important;"><b>Registration Form</b> Management</h1>
                    <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" style="float:right !important;margin-top:0px !important;" aria-label="breadcrumb">
                        <ol class="breadcrumb pt-0" style="margin-bottom:0rem !important;padding:0px !important;">
                            ...
                            <li class="breadcrumb-item">
                                <a href="#">Rejected Registration Form List</a>
                            </li>
                        </ol>
                    </nav>
                 ...
                 <div class="col-md-12 col-lg-12 col-xl-12 mb-4">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <h6 class="mb-3" style="font-weight:bold !important;text-transform:uppercase !important;font-size:15px !important;margin-bottom:3px !important;">Rejected Registration Form List</h6>
                            <p style="margin-bottom:1.4rem !important;">Following datalist allows you to manage and track Registration Form details inactive over the network.</p>
...
<b>Service Category</b>: <asp:Label ID="Label6" style="color:black !important"  runat="server" Text='<%#Eval("Servicename").ToString()%>'/>
         ...
         <br/>
<asp:Button ID="Button2" runat="server" CommandName="Advanced" CommandArgument='<%#Eval("Id")%>'  Text="Activate Account"  style="background-color:#000000 !important;color:white !important;border:none !important;padding:5px 10px !important;border-radius:3px !important;"></asp:Button>
   </div>
      </div>
 </ItemTemplate>
