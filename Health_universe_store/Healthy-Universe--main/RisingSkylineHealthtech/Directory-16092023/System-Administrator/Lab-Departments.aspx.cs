...
public partial class System_Administrator_Lab_Departments : System.Web.UI.Page
{
    ...
    protected void BindGrid()
    {
        ...
        try
        {
            SqlCommand cmd = new SqlCommand("select * from LDepartments", con);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("Select Title from LDepartments where Title=@Title", con);
            ...
            else
            {
                ...
                SqlCommand cmd1 = new SqlCommand("Insert into LDepartments (Title,Path1) values (@Title,@Path1)", con1);
    ...
    protected void grdImages_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            int imgId = Convert.ToInt32(grdImages.DataKeys[e.RowIndex].Value);
                ...
                SqlCommand cmd = new SqlCommand("delete from LDepartments where Id=@Id", con);
    ...
    protected void grdImages_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        try
        {
            ...
            using (SqlConnection con1 = new SqlConnection(constr))
            {
                ...
                con1.Open();
                SqlCommand cmd1 = new SqlCommand("update LDepartments set Title=@Title, Path1=@Path1 where Id=" + id, con1);
