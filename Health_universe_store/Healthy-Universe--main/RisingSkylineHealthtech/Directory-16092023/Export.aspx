                ...
                <div class="col-md-12 col-lg-6 col-xl-6 mb-4">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <h6 class="mb-3" style="font-weight:bold !important;text-transform:uppercase !important;font-size:15px !important;letter-spacing:0.4px !important;margin-bottom:6px !important;">Export Customer List</h6>
                            <p style="margin-bottom:1.4rem !important;">Export customer data to excel for customers registered on the network.</p>
                 ...
                 <div class="col-md-12 col-lg-6 col-xl-6 mb-4">
                    <div class="card mb-4">
                        <div class="card-body">
                             <h6 class="mb-3" style="font-weight:bold !important;text-transform:uppercase !important;font-size:15px !important;letter-spacing:0.4px !important;margin-bottom:6px !important;">Export Franchise Interest Data</h6>
                            <p style="margin-bottom:1.4rem !important;">Export request based data to excel for users interested in franchisek.</p>
