<%@ Page Title="" Language="C#" MasterPageFile="~/Doctors-Dashboard/MasterPage.master" AutoEventWireup="true" CodeFile="Support.aspx.cs" Inherits="Doctors_Dashboard_Support" %>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <h1 style="margin-bottom:15px !important;padding-bottom:0px !important;font-size:21px !important;font-weight:bold !important;margin-top: 15px !important;">Doctor Management / Doctor Id:DID000<b><asp:Label ID="Label10" runat="server" style="color:#008000 !important"></asp:Label></b>  </h1>
