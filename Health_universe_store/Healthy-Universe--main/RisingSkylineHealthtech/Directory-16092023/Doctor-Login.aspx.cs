...
public partial class Doctor_Login : System.Web.UI.Page
{
    ...
    protected void ValidateUserInfo(string user, string pass)
    {
        ...
        string sql = "SELECT * FROM Doctors WHERE Email = @Email AND Password = @password";
        ...
        if (dt.Tables[0].Rows.Count > 0)
        {
            ...
            HttpCookie mygoacookie1122 = new HttpCookie("mygoacookie1122");
            mygoacookie1122.Value = TextBox3.Text;
            mygoacookie1122.Expires = DateTime.Now.AddDays(10);
            HttpContext.Current.Response.Cookies.Add(mygoacookie1122);
            ...
            using (SqlConnection connection1 = new SqlConnection(strConnString1))
            {
                ...
                command.Parameters.Add("@Email", mygoacookie1122.Value);
                connection1.Open();
            ...
            {
                Response.Redirect("Doctors-Dashboard/Account-Suspended.aspx");
            }
            ...
            {
                Response.Redirect("Doctors-Dashboard/Default.aspx");
            }
        }
        else
        {
