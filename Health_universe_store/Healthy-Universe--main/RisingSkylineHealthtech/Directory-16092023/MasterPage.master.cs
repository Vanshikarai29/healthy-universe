...
public partial class MasterPage : System.Web.UI.MasterPage
{
    ...
    protected void Repeater3_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            rptOrders.DataSource = GetData(string.Format("SELECT Top (4) * FROM Subcategory WHERE Categoryid='{0}'", customerId));
            rptOrders.DataBind();
        }
    }
    protected void BindData1()
    {
        ...
        conn.Open();
        string cmdstr = "Select Top (8) * From Subcategory ORDER BY Id ASC";
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        if (dr.Read())
        {
            if (dr.HasRows == true)
            {
                ...
                try
                {
                    string flink = "https://healthyuniverse.com/Reset-Password.aspx?a1=" + HttpUtility.UrlEncode(Encrypt(TextBox1f.Text.Trim()));
