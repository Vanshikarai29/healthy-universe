<%@ Page Title="" Language="C#" MasterPageFile="~/Vendor-Panel/MasterPage.master" AutoEventWireup="true" CodeFile="Add-Tests.aspx.cs" Inherits="Vendor_Panel_Add_Tests" %>
...
<main style="margin-top: 70px !important;">
        <div class="container-fluid" style="padding-top: 20px !important;">
            <div class="row  ">
                <div class="col-12">
                    <h1 style="margin-bottom:0px !important;padding-bottom:0px !important;font-size:17px !important;"><b>Test</b> Management</h1>
                ...
                <asp:Label ID="Label3" style="display:none !important" runat="server"></asp:Label> 
                ...
                <div class="col-md-12 col-lg-6 col-xl-8 mb-4">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <h6 class="mb-3" style="font-weight:bold !important;text-transform:uppercase !important;font-size:15px !important;margin-bottom:6px !important;">A. List a New Test</h6>
                            <p style="margin-bottom:1.4rem !important;">Add a new Test to the network.</p>
                   ...
                   <div class="col-md-12 mb-3">
                                        <label for="validationTooltipUsername2" style="width:100% !important;">Test Title  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="one222" 
     ...
     <div class="col-md-6 mb-3">
                                        <label for="validationTooltipUsername2" style="width:100% !important;">Sample Required [Optional]</label>
                                        <div class="input-group">
                    <asp:TextBox ID="TextBox3" class="form-control" style="color:darkslateblue !important;" placeholder="Type here..." runat="server"></asp:TextBox>
                                     ...
                                     <div class="col-md-6 mb-3">
                                        <label for="validationTooltipUsername2" style="width:100% !important;">Preparations [Optional]</label>
                                        <div class="input-group">
                    <asp:TextBox ID="TextBox5" class="form-control" style="color:darkslateblue !important;" placeholder="Type here..." runat="server"></asp:TextBox>
                           ...
                           <div class="col-md-6 mb-3">
                                        <label for="validationTooltipUsername2" style="width:100% !important;">Test Description</label>
                                        <div class="input-group">
                    <asp:TextBox ID="TextBox4" class="form-control" TextMode="MultiLine" style="color:darkslateblue !important;" placeholder="Type here..." runat="server"></asp:TextBox>
                           ...
                           <div class="col-md-6 mb-3">
                                        <label for="validationTooltipUsername2" style="width:100% !important;">No of Tests  <asp:RequiredFieldValidator ID="RequiredFieldValidator3sx" ValidationGroup="one222" 
                        style="color:Red;font-weight:bold;font-size:12px;"  runat="server"
                         Text="*"
                       ...
                       <asp:TextBox ID="TextBox1" class="form-control" style="color:darkslateblue !important;" placeholder="Type here..." runat="server"></asp:TextBox>
                                ...
                                <label for="validationTooltipUsername2" style="width:100% !important;margin-top:10px !important;">List Price <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ValidationGroup="one222" 
                        style="color:Red;font-weight:bold;font-size:12px;"  runat="server"
                         Text="*"
                     ...
                     <asp:TextBox ID="TextBox6" class="form-control" onchange="validateFloatKeyPress(this);" style="color:darkslateblue !important;" placeholder="Type here..." runat="server"></asp:TextBox>
                                 ...
                                 <label for="validationTooltipUsername2" style="width:100% !important;margin-top:10px !important;">Retail Price <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ValidationGroup="one222" 
                        style="color:Red;font-weight:bold;font-size:12px;"  runat="server"
                         Text="*"
...
<%--                               <div class="col-md-12 mb-3" style="padding-right: 5px !important;padding-left: 5px !important;">
                       ...
                       <asp:DropDownList ID="DropDownList4" Enabled="false" class="form-control" runat="server"></asp:DropDownList>
                                       ...
                                       <div class="col-md-6 mb-3">
                                        <label for="validationTooltipUsername2" style="width:100% !important;">Banner <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="one222" 
                        style="color:Red;font-weight:bold;font-size:12px;"  runat="server"
                         Text="*"
                         ForeColor="Red" ControlToValidate="FileUpload1"></asp:RequiredFieldValidator>
                                
    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ValidationGroup="one222" 
    ...
    Display="Dynamic" /></label>
                     ...
                     <asp:FileUpload ID="FileUpload1" class="form-control" runat="server" />
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="validationTooltipUsername2" style="width:100% !important;">Optional Banner <asp:RegularExpressionValidator ID="RegularExpressionValidator4" ValidationGroup="one222" 
        Validationexpression="([a-zA-Z0-9\s_\\.\-:])+(.jpg|.jpeg|.png)$"
...
<%--                                    <div class="col-md-6 mb-3">
                                        <label for="validationTooltipUsername2" style="width:100% !important;">Optional Banner <asp:RegularExpressionValidator ID="RegularExpressionValidator5" ValidationGroup="one222" 
        Validationexpression="([a-zA-Z0-9\s_\\.\-:])+(.jpg|.jpeg|.png)$"
    ...
    Display="Dynamic" /></label>
                  ...
                  <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" ValidationGroup="one222" class="btn btn-secondary"
                      Text="Create Test" />
                ...
                <div class="col-md-12 col-lg-6 col-xl-12 mb-4">
                    <div class="card mb-4">
                        <div class="card-body">
                            <h6 class="mb-3" style="font-weight:bold !important;text-transform:uppercase !important;font-size:15px !important;margin-bottom:6px !important;">B. Manage Listed Tests</h6>
                            <p style="margin-bottom:1.4rem !important;">Manage all Tests listed on the network.</p>
